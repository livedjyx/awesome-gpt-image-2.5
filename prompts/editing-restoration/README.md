...
| SC-233 | [局部背景清理](SC-233/README.md) | 编辑现有图片 | 保持输入风格 | 已配图 | 首批补充 |
| SC-234 | [背景替换合成](SC-234/README.md) | 编辑现有图片 | 保持输入风格 | 已配图 | 首批补充 |
| SC-235 | [黑白照片上色](SC-235/README.md) | 编辑现有图片 | 自然写实摄影 | 已配图 | 首批补充 |
...
[查看提示词](SC-233/README.md)

![局部背景清理：实际生成结果](SC-233/images/result-01.png)

### 背景替换合成

[查看提示词](SC-234/README.md)

![背景替换合成：实际生成结果](SC-234/images/result-01.png)

### 黑白照片上色

[查看提示词](SC-235/README.md)

![黑白照片上色：实际生成结果](SC-235/images/result-01.png)
